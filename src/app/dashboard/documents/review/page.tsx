...
export default async function ReviewPage({ searchParams }: PageProps) {
  ...
  if (!document) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#03000a] text-center p-6 space-y-4">
  ...
  return (
    <div className="min-h-screen bg-[#03000a] text-slate-100 p-6 lg:p-8">
